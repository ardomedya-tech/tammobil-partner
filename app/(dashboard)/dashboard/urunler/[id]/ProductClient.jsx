        ...
        <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-[0_20px_45px_rgba(15,23,42,0.06)] md:p-8">
          ...
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div>
              ...
              <input
                placeholder="Örn. 22999"
                name="inprice"
                id="inprice"
                type="number"
                className={getFieldClasses("inprice")}
                {...register("inprice")}
              />
            </div>
            <div>
              ...
              <input
                ...
                id="indirimsize"
                type="number"
                className={getFieldClasses("indirimsize")}
                {...register("indirimsize")}
              />
            </div>
            ...
            <div>
              ...
              <select
                name="indirim"
                id="indirim"
                className={getFieldClasses("indirim")}
                {...register("indirim")}
              >
        ...
        <div className="flex flex-col gap-4 rounded-[28px] border border-slate-200 bg-white p-6 shadow-[0_20px_45px_rgba(15,23,42,0.06)] md:flex-row md:items-center md:justify-between md:p-8">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Ürün bilgilerini gözden geçirin ve kaydedin.
            </p>
          </div>
